      ...
      <div className="w-full max-w-lg space-y-12">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full bg-white hover:bg-gray-50 text-gray-700 font-medium py-2 px-6 rounded-full transition-colors duration-200 flex items-center justify-center space-x-4 disabled:opacity-50 disabled:cursor-not-allowed text-lg shadow-lg"
          >
            {loading ? (
